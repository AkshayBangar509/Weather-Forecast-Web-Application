...
async function weatherData(city) {
  ...
  for (let i = 1; i < 8; i++) {
    ...
    if (
      ...
      document.querySelector(`.i${i}`).src = "./images/moderate rain.svg";
    } else if (description == "Partly cloudy") {
      document.querySelector(`.i${i}`).src = "./images/partly cloudy.svg";
    } else if (description == "Sunny") {
      document.querySelector(`.i${i}`).src = "./images/Sunny.svg";
    } else if (description == "Heavy rain") {
      document.querySelector(`.i${i}`).src = "./images/heavy rain.svg";
    } else if (description == "Overcast") {
      document.querySelector(`.i${i}`).src = "./images/Overcast.svg";
    }
  }
}
